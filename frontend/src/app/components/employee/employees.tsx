...
import ProductsGrid from "./ui/productGrid";
...
import EmployeesGrid from "./ui/productGrid";
...
export default function Employees({ data, page, totalEmployees }: Props) {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 h-full">
        ...
        <EmployeesGrid data={data} />
        <PaginationUI
          totalPages={totalEmployees}
          currentPage={page}
          onPageChange={(pageNum) => {
            router.push(NEXT_BASE_URL + `/employee?page=${pageNum}`);
          }}
        />
      </div>
    </div>
